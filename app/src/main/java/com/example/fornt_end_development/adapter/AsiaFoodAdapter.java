package com.example.fornt_end_development.adapter;
...
import com.example.fornt_end_development.R;
import com.example.fornt_end_development.model.AsiaFood;
...
public class AsiaFoodAdapter extends RecyclerView.Adapter<AsiaFoodAdapter.AsiaFoodViewHolder> {
    ...
    public AsiaFoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.asia_popular_food_row_item, parent, false);
