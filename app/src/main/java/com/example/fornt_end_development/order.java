...
import com.example.fornt_end_development.adapter.AsiaFoodAdapter;
import com.example.fornt_end_development.adapter.PopularFoodAdapter;
...
public class order extends AppCompatActivity {
    ...
    private void setAsiaRecycler(List<AsiaFood> asiaFoodList) {
        ...
        findViewById(R.id.bottomAppBar2).setOnClickListener(new View.OnClickListener() {
            @Override
